...
public:
  ...
  */
  void configure(const fluid_camera::CameraInfo &info, size_t screenW,
                 size_t screenH);

  /*
    Phi and theta are in RADIANS.
  */
  void place(const glm::vec3 &targetPos, const double phi, const double theta,
  ...
  */
  ...
  glm::vec3 view_point() const { return targetPos; }
  glm::vec3 up_dir() const { return c2w[1]; }
